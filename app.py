...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Trung Thực - Trường TH Hùng An - ĐT: 0916168507</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Trung Thực - Trường TH Hùng An - ĐT: 0916168507</div>", unsafe_allow_html=True)
